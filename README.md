...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/microscope-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15472&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/microscope-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `microscope` can be installed with:

```
conda install microscope
```

It is possible to list all of the versions of `microscope` available on your platform with:
